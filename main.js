...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, esriapi, clicks, lang ) {
	return declare(PluginBase, {
		...
		hasCustomPrint: false, size:'small', hasHelp:false, 
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "http://dev.services.coastalresilience.org:6080/arcgis/rest/services/New_Jersey/MarshExplorer/MapServer";
			this.layerDefs = [];
		},
